...
impl WormsPacket {
    pub fn new(header: PacketCode) -> Self {
        WormsPacket {
            header_code: header,
            ..Default::default()
        }
    ...
    pub fn error_code(mut self, value: u32) -> Self {
    ...
    pub fn session(mut self, value: SessionInfo) -> Self {
